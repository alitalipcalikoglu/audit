  ...
  apps: [
    {
      ...
      exec_mode: 'fork',
      instances: 1,             // one process per SQLite file; the hash chain must have a single writer
      autorestart: true,
      ...
      kill_timeout: 35000,      // SIGTERM → finish in-flight requests and exports → exit (internal force-exit at 30s)
      merge_logs: true,
